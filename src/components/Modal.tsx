...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-955/80 backdrop-blur-md p-4 flex items-center justify-center">
      <div className={`bg-slate-900 border border-slate-800 shadow-2xl rounded-2xl w-full ${maxWidthClass} p-6 relative overflow-hidden font-sans`}>
